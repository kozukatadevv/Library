...
do
	...
	do
		...
		Library.font = Font.new(getcustomasset(font_dir .. "/main_encoded.ttf"), Enum.FontWeight.Regular)
	end
	--
...
Title.RichText = true
		...
		function Pages:PlayerList(Properties)
			...
			SectionName.FontFace = Library.font
			...
			Priority.FontFace = Library.font
			Priority.Text = ""
			...
			PriorityLabel.FontFace = Library.font
			...
			FriendLabel.FontFace = Library.font
			...
			local function createoptions(tbl)
				for i, option in next, tbl do
					...
					NewPlayer1.FontFace = Library.font
					NewPlayer1.Text = ""
		...
		function Sections:Divider(Properties)
			...
			NewDivider.FontFace = Library.font
			NewDivider.Text = ""
		...
		function Library:Indicator(Properties)
			...
			function Indicator:NewValue(Properties)
				...
				IndValue.FontFace = Library.font
			...
			function Indicator:NewBar(Properties)
				...
				IndValue1.FontFace = Library.font
				IndValue1.Text = "0"
