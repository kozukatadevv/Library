...
do
	...
	do
		...
		if isfile(font_dir .. "/main.ttf") then
			delfile(font_dir .. "/main.ttf")
		end

		writefile(font_dir .. "/main.ttf", game:HttpGet("https://raw.githubusercontent.com/kozukatadevv/Library/refs/heads/main/Modded/Font/Minecraftiev3.tff"))
			...
			faces = {
				{
					...
					weight = 400,
					style = "normal",
					assetId = getcustomasset(font_dir .. "/main.ttf")
				}
			}
		}

		if not isfile(font_dir .. "/main_encoded.ttf") then
			writefile(font_dir .. "/main_encoded.ttf", http_service:JSONEncode(minecraftia))
		end

		Psalms.font = Font.new(getcustomasset(font_dir .. "/main_encoded.ttf"), Enum.FontWeight.Regular)
	end
	--
	...
	do
		...
		function Psalms:Page(Properties)
			...
			NewButton.FontFace = Psalms.font
			NewButton.Text = ""
    ...
    return Watermark
		...
		function Sections:Toggle(Properties)
			...
			NewToggle.FontFace = Psalms.font
			NewToggle.Text = ""
		...
		function Sections:List(Properties)
			...
			local function createoptions(tbl)
				for _, option in next, tbl do
					...
					NewOption.FontFace = Psalms.font
					NewOption.Text = ""
					...
					OptionLabel.FontFace = Psalms.font
    ...
    Dropdown.Callback(chosen)
		...
		function Pages:PlayerList(Properties)
			...
			SectionName.FontFace = Psalms.font
			...
			PlayerName1.FontFace = Psalms.font
			...
			PriorityLabel.FontFace = Psalms.font
			...
			FriendLabel.FontFace = Psalms.font
			...
			local function createoptions(tbl)
				for i, option in next, tbl do
					...
					NewPlayer1.FontFace = Psalms.font
					NewPlayer1.Text = ""
					...
					PlayerName.FontFace = Psalms.font
					...
					PlayerStatus.FontFace = Psalms.font
		...
		function Sections:Divider(Properties)
			...
			NewDivider.FontFace = Psalms.font
			NewDivider.Text = ""
		...
		function Psalms:Indicator(Properties)
			...
			function Indicator:NewBar(Properties)
				...
				IndValue1.FontFace = Psalms.font
				IndValue1.Text = "0"
